...
html_theme_options = {
    'logo': 'aiopg-icon.png',
    'description': 'aiopg - Postgres integration with asyncio',
    'github_user': 'aio-libs',
    'github_repo': 'aiopg',
    'github_button': True,
    'github_type': 'star',
    'github_banner': True,
    'canonical_url': 'https://aiopg.readthedocs.io/en/stable/',
...
man_pages = [
    ('index', 'aiopg', 'aiopg Documentation',
     ['Andrew Svetlov', 'Alexey Firsov'], 1)
]
